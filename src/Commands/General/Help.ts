...
export default class extends BaseCommand {
    public override execute = async (M: Message, { context }: IArgs): Promise<void> => {
        if (!context) {
            ...
            return void (await reply(image, 'FE1EIe8XMAUx9M', undefined, undefined, text, undefined))
            ...
            text += `\n\n📕 *Note:* Use ${this.client.config.prefix}help <command_name> for more info on bot use .mod then contact owner, while for commands Example: *${this.client.config.prefix}help hello*`
